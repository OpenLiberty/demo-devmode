...
6. Add the src/main/java/io/openliberty/sample/system/SystemLivenessCheck.java class back to your application. Notice that the `mpHealth-4.0` feature is once again generated. Changes are reflected in the http://localhost:9080/health endpoint.
