# Liberty dev mode demo with automatic generation of Liberty server configuration features (tech preview)

### Quick links
[Maven generate-features goal documentation](https://github.com/OpenLiberty/ci.maven/blob/main/docs/generate-features.md)  
[Gradle generateFeatures task documentation](https://github.com/OpenLiberty/ci.gradle/blob/main/docs/generateFeatures.md)
...
<details>
    <summary>3. Create the src/main/java/io/openliberty/sample/system/SystemLivenessCheck.java class. Notice that the mphealth-3.0 feature is generated and installed. Changes are reflected in the http://localhost:9080/health endpoint.  </summary>
...
Notice that the `src/main/liberty/config/configDropins/overrides/generated-features.xml` file was updated and now contains the mpHealth-3.0 feature.
```xml
<?xml version="1.0" encoding="UTF-8"?>
<server>
    <!--This file was generated by the Liberty Maven Plugin and will be overwritten on subsequent runs of the liberty:generate-features goal.
...
4. Delete the src/main/java/io/openliberty/sample/system/SystemLivenessCheck.java class. Notice that the mpHealth-3.0 feature still exists in `src/main/liberty/config/configDropins/overrides/generated-features.xml`.

5. Go to the console where you started dev mode, press 'o' and Enter. This will re-scan all class files and generate an "optimized" list of features. Notice that the mpHealth-3.0 feature no longer exists in `src/main/liberty/config/configDropins/overrides/generated-features.xml` as it is no longer needed.

6. Add the src/main/java/io/openliberty/sample/system/SystemLivenessCheck.java class back to your application. Notice that the mphealth-3.0 feature is once again generated and installed. Changes are reflected in the http://localhost:9080/health endpoint.
